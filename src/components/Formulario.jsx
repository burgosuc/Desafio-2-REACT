...
function Formulario ({ addAlert }) {
  ...
  function inputsHandler (e) {
    if (e.target.id === 'nombre') setInputs({ ...inputs, nombre: e.target.value })
    if (e.target.id === 'email') setInputs({ ...inputs, email: e.target.value })
    if (e.target.id === 'password') setInputs({ ...inputs, password: e.target.value })
    if (e.target.id === 'passwordOne') setInputs({ ...inputs, passwordOne: e.target.value })
  }
  ...
  function validacionInputs (e) {
    ...
    if (
      ...
      addAlert({
        texto: 'El nombre no debe contener caracteres especiales y minimo 4 caracteres 😕!',
        tipo: 'alert-warning',
        estado: true
      })
      ...
      addAlert({
        texto: 'La contraseña debe tener, al menos una letra mayúscula, una letra minúscula y un número y minimo 8 caracteres 😕!',
        tipo: 'alert-danger',
        estado: true
      })
